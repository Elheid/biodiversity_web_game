...
const serverIp = "localhost";//.168.1.187:5001
export const SERVER_URL = `http://${serverIp}:5001`//"http://localhost:5001";

export const ROUND_TARGET_FIRST = "Найди животноеи определи его вид";
export const ROUND_TARGET_SECOND = "Оцени работу с AI-помощником";
